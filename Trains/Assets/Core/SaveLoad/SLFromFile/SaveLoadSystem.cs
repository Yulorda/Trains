...
{
    public static SaveSnapshot GetSave()
    {
        int id = 0;
        var connectionPoints = Manager.GetInstance().models
        ...
        var connections = Manager.GetInstance().models
        ...
        var pointOnConnection = Manager.GetInstance().models
    ...
    public static void Load(SaveSnapshot saveSnapshot)
    {
        ...
        var dicConnectionPoint = saveSnapshot.models.Where(x => x.type == typeof(SaveSnapshot.ConnectionPoint)).
            Select(y =>
            {
                ...
                Manager.GetInstance().RegistrateModel(coonectionPoint.obj.obj, coonectionPoint.obj.type);
        ...
        var dicConnection = saveSnapshot.models.Where(x => x.type == typeof(SaveSnapshot.Connection)).
           Select(y =>
           {
               ...
               Manager.GetInstance().RegistrateModel(saveCoonection.obj.obj, saveCoonection.obj.type);
        ...
        saveSnapshot.models.Where(x => x.type == typeof(SaveSnapshot.PointOnConnection)).ToList()
           .ForEach(y =>
           {
               ...
               Manager.GetInstance().RegistrateModel(savePointOnConnection.obj.obj, savePointOnConnection.obj.type);
           });
    }
}
